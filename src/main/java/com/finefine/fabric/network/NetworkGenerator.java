package com.finefine.fabric.network;
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < clients.length; i++) {
			try {
				...
				JsonObject json = new NetworkBuilder(domain).name("fabric-gateway-sdk-demo").clientOrg(clients[i])
						...
						.url("Org1", "*", "localhost").url("Org2", "*", "localhost")
						.url("orderer", "*", "localhost").port("Org1", "peer0", 7051).port("Org1", "peer1", 8051)
